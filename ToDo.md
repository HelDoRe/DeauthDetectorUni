   ...
   * define DEBUG ON OFF a potem IFDEF, i jak lib od e-paper ma wyl/wl debuga i inne biblioteki, zeby czysty serial monitor byl (zaczete) 
   * rozbic dane, song, includy itp. do .h (zaczete) 
   * wyswietlanie - zrobic na rozne ekrany przez IFDEFy (zaczete) 
   * porzadki w zmiennych, define, stringi (wyciagnac wyswietlane slowa do zmiennych i moze multilanguage pozniej sie zrobi) (zaczete) 
   * dorzucic IFDEFy dla roznych urzadzen wyjsciowych (zaczete) 
   * ogarnac wyglad kodu (zaczete) 
